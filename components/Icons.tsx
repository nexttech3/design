...
export const MagicWandIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M9.53 16.122a3 3 0 00-5.78 1.128 2.25 2.25 0 01-2.47 2.118L2.25 12l2.002-2.002a2.25 2.25 0 012.47-2.118 3 3 0 005.78 1.128zM12.963 8.878a3 3 0 015.78-1.128 2.25 2.25 0 002.47-2.118L21.75 12l-2.002 2.002a2.25 2.25 0 00-2.47 2.118 3 3 0 01-5.78-1.128z" />
  </svg>
);
